...
public final class ModFluids {
    private static final class HbmFluidType extends FluidType {
        private HbmFluidType(Properties properties) {
            super(properties);
        }
        ...
        public String getDescriptionId() {
            ...
            return key == null ? super.getDescriptionId() : "hbmfluid." + key.getPath();
        }
    }
    ...
    public static final DeferredHolder<FluidType, FluidType> SMOKE_TYPE = FLUID_TYPES.register(
            "smoke", () -> new HbmFluidType(FluidType.Properties.create())
    );
    ...
    public static final DeferredHolder<FluidType, FluidType> STEAM_TYPE = FLUID_TYPES.register(
            "steam", () -> new HbmFluidType(FluidType.Properties.create().density(-100).temperature(373)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HOTSTEAM_TYPE = FLUID_TYPES.register(
            "hotsteam", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(573)));
    ...
    public static final DeferredHolder<FluidType, FluidType> SUPERHOTSTEAM_TYPE = FLUID_TYPES.register(
            "superhotsteam", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(723)));
    ...
    public static final DeferredHolder<FluidType, FluidType> ULTRAHOTSTEAM_TYPE = FLUID_TYPES.register(
            "ultrahotsteam", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(873)));
    ...
    public static final DeferredHolder<FluidType, FluidType> COOLANT_TYPE = FLUID_TYPES.register(
            "coolant", () -> new HbmFluidType(FluidType.Properties.create().density(1_000).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> COOLANT_HOT_TYPE = FLUID_TYPES.register(
            "coolant_hot", () -> new HbmFluidType(FluidType.Properties.create().density(1_000).temperature(873)));
    ...
    public static final DeferredHolder<FluidType, FluidType> PEROXIDE_TYPE = FLUID_TYPES.register(
            "peroxide", () -> new HbmFluidType(FluidType.Properties.create()));
    ...
    public static final DeferredHolder<FluidType, FluidType> SULFURIC_ACID_TYPE = FLUID_TYPES.register(
            "sulfuric_acid", () -> new HbmFluidType(FluidType.Properties.create().density(1840).viscosity(1000)));
    ...
    public static final DeferredHolder<FluidType, FluidType> OIL_TYPE = FLUID_TYPES.register(
            "oil", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HOTOIL_TYPE = FLUID_TYPES.register(
            "hotoil", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(623)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HEAVYOIL_TYPE = FLUID_TYPES.register(
            "heavyoil", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> NAPHTHA_TYPE = FLUID_TYPES.register(
            "naphtha", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> LIGHTOIL_TYPE = FLUID_TYPES.register(
            "lightoil", () -> new HbmFluidType(FluidType.Properties.create().density(800).viscosity(1_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> BITUMEN_TYPE = FLUID_TYPES.register(
            "bitumen", () -> new HbmFluidType(FluidType.Properties.create().density(950).viscosity(6_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> SMEAR_TYPE = FLUID_TYPES.register(
            "smear", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HEATINGOIL_TYPE = FLUID_TYPES.register(
            "heatingoil", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> WOODOIL_TYPE = FLUID_TYPES.register(
            "woodoil", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> COALCREOSOTE_TYPE = FLUID_TYPES.register(
            "coalcreosote", () -> new HbmFluidType(FluidType.Properties.create().density(900).viscosity(3_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> LUBRICANT_TYPE = FLUID_TYPES.register(
            "lubricant", () -> new HbmFluidType(FluidType.Properties.create().density(850).viscosity(2_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> DIESEL_TYPE = FLUID_TYPES.register(
            "diesel", () -> new HbmFluidType(FluidType.Properties.create().density(830).viscosity(1_500)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> KEROSENE_TYPE = FLUID_TYPES.register(
            "kerosene", () -> new HbmFluidType(FluidType.Properties.create().density(800).viscosity(1_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> GASOLINE_TYPE = FLUID_TYPES.register(
            "gasoline", () -> new HbmFluidType(FluidType.Properties.create().density(750).viscosity(700).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> GASOLINE_LEADED_TYPE = FLUID_TYPES.register(
            "gasoline_leaded", () -> new HbmFluidType(FluidType.Properties.create().density(760).viscosity(700).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> COALGAS_TYPE = FLUID_TYPES.register(
            "coalgas", () -> new HbmFluidType(FluidType.Properties.create().density(780).viscosity(800).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> COALGAS_LEADED_TYPE = FLUID_TYPES.register(
            "coalgas_leaded", () -> new HbmFluidType(FluidType.Properties.create().density(790).viscosity(800).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> PETROLEUM_TYPE = FLUID_TYPES.register(
            "petroleum", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> GAS_TYPE = FLUID_TYPES.register(
            "gas", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100).temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> CARBONDIOXIDE_TYPE = FLUID_TYPES.register(
            "carbondioxide", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HYDROGEN_TYPE = FLUID_TYPES.register(
            "hydrogen", () -> new HbmFluidType(FluidType.Properties.create().density(71).viscosity(100)
                    .temperature(13)));
    ...
    public static final DeferredHolder<FluidType, FluidType> DEUTERIUM_TYPE = FLUID_TYPES.register(
            "deuterium", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(23)));
    ...
    public static final DeferredHolder<FluidType, FluidType> TRITIUM_TYPE = FLUID_TYPES.register(
            "tritium", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(25)));
    ...
    public static final DeferredHolder<FluidType, FluidType> SAS3_TYPE = FLUID_TYPES.register(
            "sas3", () -> new HbmFluidType(FluidType.Properties.create().density(1_000).viscosity(1_000)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> CRYOGEL_TYPE = FLUID_TYPES.register(
            "cryogel", () -> new HbmFluidType(FluidType.Properties.create().density(1_000).viscosity(3_000)
                    .temperature(103)));
    ...
    public static final DeferredHolder<FluidType, FluidType> UNSATURATEDS_TYPE = FLUID_TYPES.register(
            "unsaturateds", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> SPENTSTEAM_TYPE = FLUID_TYPES.register(
            "spentsteam", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(373)));
    ...
    public static final DeferredHolder<FluidType, FluidType> AIR_TYPE = FLUID_TYPES.register(
            "air", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> AIRBLAST_TYPE = FLUID_TYPES.register(
            "airblast", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(1_200)));
    ...
    public static final DeferredHolder<FluidType, FluidType> FLUE_TYPE = FLUID_TYPES.register(
            "flue", () -> new HbmFluidType(FluidType.Properties.create().density(-100).viscosity(100)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> MERCURY_TYPE = FLUID_TYPES.register(
            "mercury", () -> new HbmFluidType(FluidType.Properties.create().density(13_534).viscosity(1_500)
                    .temperature(293)));
    ...
    public static final DeferredHolder<FluidType, FluidType> BLOOD_TYPE = FLUID_TYPES.register(
            "blood", () -> new HbmFluidType(FluidType.Properties.create().density(1_060).viscosity(3_000)
                    .temperature(310)));
    ...
    public static final DeferredHolder<FluidType, FluidType> OXYGEN_TYPE = FLUID_TYPES.register(
            "oxygen", () -> new HbmFluidType(FluidType.Properties.create().temperature(173)));
    ...
    public static final DeferredHolder<FluidType, FluidType> PAIN_TYPE = FLUID_TYPES.register(
            "pain", () -> new HbmFluidType(FluidType.Properties.create().viscosity(3_000).temperature(300)));
