...
import com.hbm.ntm.item.ArtilleryAmmoItem;
...
import com.hbm.ntm.item.HimarsAmmoItem;
...
public final class ModItems {
    ...
    public static final DeferredItem<BlockItem> TURRET_RICHARD_ITEM;
    public static final DeferredItem<BlockItem> TURRET_HOWARD_ITEM;
    public static final DeferredItem<BlockItem> TURRET_FRITZ_ITEM;
    public static final DeferredItem<BlockItem> TURRET_MAXWELL_ITEM;
    public static final DeferredItem<BlockItem> TURRET_ARTY_ITEM;
    public static final DeferredItem<BlockItem> TURRET_HIMARS_ITEM;
    public static final DeferredItem<BlockItem> TURRET_SENTRY_ITEM;
    public static final DeferredItem<TurretChipItem> TURRET_CHIP;
    public static final DeferredItem<Item> AMMO_DGK;
    public static final DeferredItem<ArtilleryAmmoItem> AMMO_ARTY;
    public static final DeferredItem<HimarsAmmoItem> AMMO_HIMARS;
    public static final DeferredItem<Item> UPGRADE_5G;
    public static final DeferredItem<Item> UPGRADE_SCREM;
    ...
    static {
        ...
        TURRET_RICHARD_ITEM = ITEMS.registerSimpleBlockItem("turret_richard", ModBlocks.TURRET_RICHARD);
        TURRET_HOWARD_ITEM = ITEMS.registerSimpleBlockItem("turret_howard", ModBlocks.TURRET_HOWARD);
        TURRET_FRITZ_ITEM = ITEMS.registerSimpleBlockItem("turret_fritz", ModBlocks.TURRET_FRITZ);
        TURRET_MAXWELL_ITEM = ITEMS.registerSimpleBlockItem("turret_maxwell", ModBlocks.TURRET_MAXWELL);
        TURRET_ARTY_ITEM = ITEMS.registerSimpleBlockItem("turret_arty", ModBlocks.TURRET_ARTY);
        TURRET_HIMARS_ITEM = ITEMS.registerSimpleBlockItem("turret_himars", ModBlocks.TURRET_HIMARS);
        TURRET_SENTRY_ITEM = ITEMS.registerSimpleBlockItem("turret_sentry", ModBlocks.TURRET_SENTRY);
        TURRET_CHIP = ITEMS.register("turret_chip", TurretChipItem::new);
        AMMO_DGK = ITEMS.registerSimpleItem("ammo_dgk", new Item.Properties());
        AMMO_ARTY = ITEMS.register("ammo_arty", ArtilleryAmmoItem::new);
        AMMO_HIMARS = ITEMS.register("ammo_himars", HimarsAmmoItem::new);
        UPGRADE_5G = ITEMS.registerSimpleItem("upgrade_5g", new Item.Properties().stacksTo(1));
        UPGRADE_SCREM = ITEMS.registerSimpleItem("upgrade_screm", new Item.Properties().stacksTo(1));
