...
import com.hbm.ntm.recipe.ArcFurnaceRecipes.Recipe;
...
public final class ArcFurnaceSolidRecipeCategory implements IRecipeCategory<Recipe> {
    ...
    public ArcFurnaceSolidRecipeCategory(IGuiHelper gui) {
        background = gui.createDrawable(TEXTURE, 5, 11, 166, 65);
        icon = gui.createDrawableItemLike(ModItems.MACHINE_ARC_FURNACE_ITEM.get());
    ...
    public RecipeType<Recipe> getRecipeType() {
        return HbmJeiPlugin.ARC_FURNACE_SOLID;
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, Recipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.RENDER_ONLY, 75, 31)
                .addItemStack(new ItemStack(ModItems.MACHINE_ARC_FURNACE_ITEM.get()));
    }
